...
#include "core/input/RpgInputTypes.h"
...
#define RPG_GUI_SCROLL_VALUE_FIRST		0.0f
#define RPG_GUI_SCROLL_VALUE_LAST		999999.0f
...
namespace RpgGui
{
	enum Flags : uint16_t
	{
		...
		FLAG_Layout				= (1 << 0),
		FLAG_InputFocus			= (1 << 1),
		FLAG_DragDrop_Source	= (1 << 2),
		FLAG_DragDrop_Target	= (1 << 3),
