...
public:
	...
	{
		return RpgStringID("RpgAssetObject");
	}
	...
	inline RpgStringID GetAssetName() const noexcept
	{
		return Name;
	}

	inline RpgStringID GetAssetPath() const noexcept
	{
		return Path;
	}
...
public:																										\
	virtual RpgStringID GetAssetClassName() const noexcept override { return RpgStringID(#classType); }		\
