...
typedef RpgSharedPtr<class RpgTextureRenderTarget> RpgSharedTextureRenderTarget;
typedef RpgSharedPtr<class RpgTextureDepthStencil> RpgSharedTextureDepthStencil;
...
public:
	RpgTexture2D(const RpgStringID& in_Name) noexcept;
	RpgTexture2D(const RpgStringID& in_Name, RpgTextureFormat::EType in_Format, uint16_t in_Width, uint16_t in_Height, uint8_t in_MipCount) noexcept;
...
{
public:
	RpgTextureRenderTarget(const RpgStringID& in_Name, RpgTextureFormat::EType in_Format, uint16_t in_Width, uint16_t in_Height) noexcept;
...
{
public:
	RpgTextureDepthStencil(const RpgStringID& in_Name, RpgTextureFormat::EType in_Format, uint16_t in_Width, uint16_t in_Height) noexcept;
...
{
public:
	RpgTextureDepthCube(const RpgStringID& in_Name, RpgTextureFormat::EType in_Format, uint16_t in_Width, uint16_t in_Height) noexcept;
