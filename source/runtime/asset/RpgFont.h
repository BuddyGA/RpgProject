...
public:
	RpgFont(const RpgStringID& in_Name, const RpgString& ttfFilePath, float in_SizePx, int in_UnicodeStart, int in_UnicodeCount) noexcept;
	~RpgFont() noexcept;
...
public:
	[[nodiscard]] static RpgSharedFont CreateShared(const RpgStringID& name, const RpgString& ttfFilePath, float sizePx, int unicodeStart, int unicodeCount) noexcept;
